...
#include "caffe/layers/weighted_valid_pair_loss_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void WeightedValidPairLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void WeightedValidPairLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void WeightedValidPairLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void WeightedValidPairLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(WeightedValidPairLossLayer);
#endif

INSTANTIATE_CLASS(WeightedValidPairLossLayer);
REGISTER_LAYER_CLASS(WeightedValidPairLoss);
