...
void caffe_axpy(const int N, const Dtype alpha, const Dtype* X,
    Dtype* Y);
template <typename Dtype>
void caffe_strided_axpy(const int N, const Dtype alpha, const Dtype* X, const int stride_a, 
    Dtype* Y, const int stride_b);

template <typename Dtype>
void caffe_cpu_axpby(const int N, const Dtype alpha, const Dtype* X,
    const Dtype beta, Dtype* Y);
template <typename Dtype>
void caffe_cpu_strided_axpby(const int N, const Dtype alpha, const Dtype* X, const int incx, 
