#ifndef CAFFE_WEIGHTED_CONTRASTIVE_LOSS_LAYER_HPP_
#define CAFFE_WEIGHTED_CONTRASTIVE_LOSS_LAYER_HPP_
...
class WeightedContrastiveLossLayer : public LossLayer<Dtype> {
 public:
   /**
    * @param param provides LossParameter loss_param, with options:
    *   
    */
  explicit WeightedContrastiveLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedContrastiveLoss"; }
...
#endif  // CAFFE_WEIGHTED_CONTRASTIVE_LOSS_LAYER_HPP_