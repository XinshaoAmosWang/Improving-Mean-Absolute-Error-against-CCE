...
#include "caffe/layers/OHPM_weighted_pair_loss_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void OHPMWeightedPairLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void OHPMWeightedPairLossLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void OHPMWeightedPairLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void OHPMWeightedPairLossLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(OHPMWeightedPairLossLayer);
#endif

INSTANTIATE_CLASS(OHPMWeightedPairLossLayer);
REGISTER_LAYER_CLASS(OHPMWeightedPairLoss);
