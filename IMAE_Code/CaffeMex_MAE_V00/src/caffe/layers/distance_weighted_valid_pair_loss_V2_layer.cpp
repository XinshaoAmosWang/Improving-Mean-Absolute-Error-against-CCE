...
#include "caffe/layers/distance_weighted_valid_pair_loss_V2_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void DistanceWeightedValidPairLossV2Layer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void DistanceWeightedValidPairLossV2Layer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void DistanceWeightedValidPairLossV2Layer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void DistanceWeightedValidPairLossV2Layer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(DistanceWeightedValidPairLossV2Layer);
#endif

INSTANTIATE_CLASS(DistanceWeightedValidPairLossV2Layer);
REGISTER_LAYER_CLASS(DistanceWeightedValidPairLossV2);
